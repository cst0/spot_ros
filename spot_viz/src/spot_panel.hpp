...
private:
  ...
  ros::ServiceClient undockService;
  ros::ServiceClient dockService;
  ros::ServiceClient stowArmService_;
  ros::ServiceClient gripperOpenService_;
  ros::ServiceClient gripperCloseService_;
